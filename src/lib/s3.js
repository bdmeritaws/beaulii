...
const BUCKET_NAME = process.env.AWS_S3_BUCKET_NAME || "beaulii";
const CDN_URL = process.env.AWS_CDN_URL || `https://${BUCKET_NAME}.s3.${process.env.AWS_REGION || "us-east-1"}.amazonaws.com`;
